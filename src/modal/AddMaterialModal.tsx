      ...
      <div className="w-[50%] h-[70%] flex flex-col gap-3 bg-white py-6 px-8">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              value={material?.id}
              name="id"
              className="border border-[#DEDEDE] rounded-md px-3 py-1"
              placeholder="eg. MS Wire"
            />
          </div>
          <div className="flex flex-col gap-1">
        ...
        <div className="flex justify-end">
          <div className="flex gap-4">
            <button
              className="px-4 py-2 rounded-lg border border-[#666666] text-[#666666]"
              onClick={() => navigate("/")}
            >
              Cancel
            </button>
            <button
              ...
              className="bg-[#283093] text-white rounded-lg px-4 py-2"
            >
              Add Material
            </button>
          </div>
